...
export default function Header({ isCoursePage = false }: { isCoursePage?: boolean }) {
  ...
  const scrollToSection = (id: string) => {
    // Don't try to scroll if we're on the courses page - these sections don't exist there
    if (isCoursePage) {
      return;
    }
    ...
    >
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex space-x-8">
          {isCoursePage ? (
            // Navigation links for Courses page
            <>
              <a 
                href="/" 
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-gray-900/95 backdrop-blur-md border-t border-red-500/20 shadow-lg animate-fadeIn">
          <div className="px-4 pt-2 pb-3 space-y-1">
            {isCoursePage ? (
              // Mobile Navigation for Courses page
              <>
                <a 
                  href="/" 
