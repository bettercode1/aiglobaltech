            ...
            <div className="md:w-1/2">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button 
                  ...
                  className="bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white font-medium py-3 px-6 rounded shadow-lg hover:shadow-red-900/20 text-center transition-all duration-300"
                >
                  ENROLL NOW
                </button>
                <button 
            ...
            <div className="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden shadow-2xl">
              <div className="p-8">
                ...
                <div className="text-center">
                  <button className="bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white font-medium py-3 px-8 rounded-lg shadow-lg hover:shadow-red-900/20 text-center transition-all duration-300">
                    ENROLL NOW
                  </button>
